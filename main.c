...
int main(int argc, char *argv[]) {
    ...
    if (!test_mode) {
        ...
        init_pair(2, ed.config.colors.selection_fg, ed.config.colors.selection_bg);
        init_pair(3, ed.config.colors.semicolon_fg, ed.config.colors.semicolon_bg);
        init_pair(4, ed.config.colors.meta_level1_fg, ed.config.colors.meta_level1_bg);
        init_pair(5, ed.config.colors.meta_level2_fg, ed.config.colors.meta_level2_bg);
