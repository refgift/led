...
- **Search Functionality**: Regex search is now stable and crash-free, with proper handling of zero-terminated strings. However, it only searchs for the first match.
## Limitations
